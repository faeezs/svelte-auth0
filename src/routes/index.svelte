...
<script>
	...
	import { isAuthenticated, user, user_tasks, tasks, isAuthorized } from '../store.js';
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	<a class="navbar-brand" href="/#">App Place</a>
	<button
	...
	<div class="collapse navbar-collapse" id="navbarText">
		<div class="navbar-nav mr-auto user-details">
			{#if $isAuthenticated}
				<span class="text-white">&nbsp;&nbsp;Welcome {$user.given_name}</span>
			{:else}<span>&nbsp;</span>{/if}
		</div>
	...
	<div class="container mt-5">
		<div class="row">
			<div class="col-md-10 offset-md-1">
				<div class="jumbotron">
					<h1 class="display-4">A Place for Data Apps!</h1>
					<p class="lead">Get started:</p>
					<ul>
						<li>Login to start &#128272;</li>
						<li>Authorized users see stuff &#128202;</li>
						<li>Unauthorized users see other stuff &#9940;</li>
					</ul>
...
{:else}
	<div class="container" id="main-application">
		<h1>Unauthorized</h1>
		<h2>You don't seem to have the required credentials to see the apps</h2>
    <p>Contact me at the provided email</p>
		<a href="faeezs@gmail.com">faeezs@gmail.com</a>
	</div>
{/if}
